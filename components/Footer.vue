<template>
  ...
  <div class="max-w-screen-xl mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-x-8">
    <div>
      <nuxt-link to="/"><img class="footerLogo" src="../assets/PAT LOGO 2 - 230121.png" alt="UptimeMate logo"></nuxt-link>
    </div>
    <div>
      <h5 class="text-xl font-semibold text-white">Plan du site</h5>
      <nav class="mt-4">
        <ul class="space-y-2">
          <li>
    ...
    <div>
      ...
      <div class="space-y-4 md:space-y-6 mt-4">
        ...
        <div class="flex items-start space-x-4">
          <div>
            <svg class="w-6 h-6 mt-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <div class="max-w-screen-xl mx-auto flex flex-col items-center mt-16">
    <div class="flex items-center space-x-2">
      <a href="https://www.facebook.com/osteopatheportedesaintcloud" target="_blank" rel="noopener" class="hover:text-gray-100">
        <span class="sr-only">Facebook</span>
        <svg class="h-6 w-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
          <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" />
        </svg>
      </a>
      <a target="_blank" rel="noopener" href="https://www.instagram.com/osteopathe.paris16/" class="hover:text-gray-100">
      ...
      <a href="https://www.linkedin.com/in/patriciachung/" target="_blank" rel="noopener" class="hover:text-gray-100">
        <span class="sr-only">LinkedIn</span>
       <svg role="img" class="h-6 w-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>LinkedIn icon</title><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
      </a>
    </div>
