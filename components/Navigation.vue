   ...
   <div class="navigation">
            ...
            <nav class="navigation__nav">
                <ul class="navigation__list">
                    ...
                    <li class="navigation__item"><a href="https://www.doctolib.fr/osteopathe/paris/patricia-chung" target="_blank" rel="noopener" class="navigation__link"><span>04</span>Prendre RDV</a></li>
...
$color-black: #000;
    ...
    &__background {
        ...
        top: 65px;
        right: 65px;
        background-image: radial-gradient(#8360c3, #2ebf91);
        z-index: 1000;
