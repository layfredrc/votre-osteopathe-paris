			...
			<div class="drainage-container transition4 ">
				...
				<div class="drainage-card">
					<div>
						...
						<p class="drainage-p"  >Vous souffrez de rétention d’eau ? Les oedèmes, la mauvaise circulation sanguine ou encore la cellulite sont votre quotidien ? <br> <br>Le drainage lymphatique de la méthode Renata França pourra vous aider. 
						</p>
					</div>
				...
				<div class="drainage-card2">
					<div>
						...
						<p class="drainage-p">
							Ce drainage permet de ‘sécher’ et d’affiner le corps avec des résultats visibles dès la première séance. Il faudra alors compléter cette session par une pratique sportive régulière et une alimentation saine.
						</p>
