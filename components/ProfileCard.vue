            ...
            <div class="max-w-5xl flex items-center h-screen flex-wrap mx-auto lg:mx-6 xl:mx-auto lg:my-0">
                ...
                <div id="profile" class="w-full h-72 lg:w-3/5 rounded-lg lg:rounded-l-xl lg:rounded-r-none shadow-2xl bg-white mt-12 lg:mt-0 mx-6 lg:mx-0">
                    ...
                    <div class="p-4 md:p-8 text-center lg:text-left">
                        ...
                        <img class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center" src="../assets/pat.webp"/>
                       ...
                       <a href="https://www.google.com/maps/dir//48.8407981,2.2565078/@48.840798,2.256508,14z?hl=fr" target="_blank">
                ...
                <div class="w-full lg:w-2/5">
                    ...
                    <img src="../assets/gal-5.webp" class="rounded-none lg:rounded-r-xl shadow-2xl hidden lg:block ">
