    ...
    >
      <div class="container mx-auto px-10 ">
        ...
        <div class="max-w-3xl mx-auto tarifs">
          ...
          >
            <h4 class="text-sm md:text-lg lg:text-2xl">
              Consultation d'ostéopathie
            </h4>

            <div
              class="flex space-x-4 md:space-x-8 lg:space-x-8 xl:space-x-8 text-center text-xl font-bold"
            >
              <div>
                <p class="text-sm">65€</p>
                <span
                  class="block text-xs md:text-sm lg:text-sm xl:text-sm font-normal"
                  >CB/espèces</span
                >
              </div>
        ...
        <div class="max-w-3xl mx-auto tarifs">
          ...
          >
            <h4 class="text-sm md:text-lg lg:text-2xl">
              Consultation d'ostéopathie enfant
            </h4>
        ...
        <div class="max-w-3xl mx-auto tarifs">
          ...
          >
            <h4 class="text-sm md:text-lg lg:text-2xl">
              Urgence ostéopathie à domicile <br />
              (Paris)
            </h4>
