<template>
    <div>
        <!-- Overview  ============================================================================= -->
		<div id="about" class="relative bg-dark-green lg:pt-12 pb-24">
			...
			<div class="relative container mx-auto px-6 lg:px-10">
				<h2 class="lg:mb-10 mb-4 pt-6 text-3xl lg:text-5xl font-bold text-white">
					Quand consulter mon Ostéopathe ?
				</h2>

				<div class="lg:flex lg:space-x-16 space-y-8 lg:space-y-0 lg:p-12 p-2">
					<!-- left col  -->
					<div
					...
					>
						...
						<p>
							...
							<a href="https://scotch.io" class="text-green-500 hover:underline"
								>Scotch.io</a
							>, my CSS files became littered with my own
							<code
								class="inline-block px-1 rounded text-s bg-gray-200 font-mono text-red-700"
								>!important</code
							>
						...
						<p>
							<strong class="font-bold">Important Note:</strong> Tailwind lets
